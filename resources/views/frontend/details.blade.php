...
<body>
    ...
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
        <div class="wrap-product-detail">
            <div class="row">
                <div class="col"><div class="detail-media">
                    <div class="product-gallery">
                        <ul class="slides">

                            <li data-thumb="/storage/product/{{ $product->image }}">
                                <img src="/storage/product/{{ $product->image }}" height="500" width="500" alt="product thumbnail" />
                            </li>

                        </ul>
                    </div>
                </div></div>
                <div class="col"><div class="detail-info">
                    ...
                    <div class="wrap-price"><span
                            class="product-price">{{ $product->selling_price - $product->discount_image }}</span></div>
